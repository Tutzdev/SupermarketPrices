...
export function ContributionsPage() {
  ...
  const products = useQuery({ queryKey: ["products", "contributions"], queryFn: () => catalogApi.products({ size: 100 }) });
